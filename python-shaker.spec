...
Summary:        pyshaker documentation
...
%if 0%{?with_python3}
%py3_install
cp %{buildroot}/%{_bindir}/shaker %{buildroot}/%{_bindir}/shaker-3
ln -sf %{_bindir}/shaker-3 %{buildroot}/%{_bindir}/shaker-%{python3_version}
cp %{buildroot}/%{_bindir}/shaker-agent %{buildroot}/%{_bindir}/shaker-agent-3
ln -sf %{_bindir}/shaker-agent-3 %{buildroot}/%{_bindir}/shaker-agent-%{python3_version}
cp %{buildroot}/%{_bindir}/shaker-spot %{buildroot}/%{_bindir}/shaker-spot-3
ln -sf %{_bindir}/shaker-spot-3 %{buildroot}/%{_bindir}/shaker-spot-%{python3_version}
cp %{buildroot}/%{_bindir}/shaker-report %{buildroot}/%{_bindir}/shaker-report-3
ln -sf %{_bindir}/shaker-report-3 %{buildroot}/%{_bindir}/shaker-report-%{python3_version}
cp %{buildroot}/%{_bindir}/shaker-image-builder %{buildroot}/%{_bindir}/shaker-image-builder-3
ln -sf %{_bindir}/shaker-image-builder-3 %{buildroot}/%{_bindir}/shaker-image-builder-%{python3_version}
cp %{buildroot}/%{_bindir}/shaker-cleanup %{buildroot}/%{_bindir}/shaker-cleanup-3
ln -sf %{_bindir}/shaker-cleanup-3 %{buildroot}/%{_bindir}/shaker-cleanup-%{python3_version}
cp %{buildroot}/%{_bindir}/shaker-all-in-one %{buildroot}/%{_bindir}/shaker-all-in-one-3
ln -sf %{_bindir}/shaker-all-in-one-3 %{buildroot}/%{_bindir}/shaker-all-in-one-%{python3_version}
%endif

%py2_install
cp %{buildroot}/%{_bindir}/shaker %{buildroot}/%{_bindir}/shaker-2
ln -sf %{_bindir}/shaker-2 %{buildroot}/%{_bindir}/shaker-%{python2_version}
cp %{buildroot}/%{_bindir}/shaker-agent %{buildroot}/%{_bindir}/shaker-agent-2
ln -sf %{_bindir}/shaker-agent-2 %{buildroot}/%{_bindir}/shaker-agent-%{python2_version}
cp %{buildroot}/%{_bindir}/shaker-spot %{buildroot}/%{_bindir}/shaker-spot-2
ln -sf %{_bindir}/shaker-spot-2 %{buildroot}/%{_bindir}/shaker-spot-%{python2_version}
cp %{buildroot}/%{_bindir}/shaker-report %{buildroot}/%{_bindir}/shaker-report-2
ln -sf %{_bindir}/shaker-report-2 %{buildroot}/%{_bindir}/shaker-report-%{python2_version}
cp %{buildroot}/%{_bindir}/shaker-image-builder %{buildroot}/%{_bindir}/shaker-image-builder-2
ln -sf %{_bindir}/shaker-image-builder-2 %{buildroot}/%{_bindir}/shaker-image-builder-%{python2_version}
cp %{buildroot}/%{_bindir}/shaker-cleanup %{buildroot}/%{_bindir}/shaker-cleanup-2
ln -sf %{_bindir}/shaker-cleanup-2 %{buildroot}/%{_bindir}/shaker-cleanup-%{python2_version}
cp %{buildroot}/%{_bindir}/shaker-all-in-one %{buildroot}/%{_bindir}/shaker-all-in-one-2
ln -sf %{_bindir}/shaker-all-in-one-2 %{buildroot}/%{_bindir}/shaker-all-in-one-%{python2_version}
